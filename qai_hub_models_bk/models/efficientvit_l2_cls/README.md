...
```bash
python -m qai_hub_models.models.efficientvit_l2_cls.demo { --quantize w8a16_mixed_fp16, w8a16 }
```
...
```bash
python -m qai_hub_models.models.efficientvit_l2_cls.export { --quantize w8a16_mixed_fp16, w8a16 }
```
