...
```bash
python -m qai_hub_models.models.detr_resnet50.demo { --quantize w8a16_mixed_int16 }
```
...
```bash
python -m qai_hub_models.models.detr_resnet50.export { --quantize w8a16_mixed_int16 }
```
