...
def combine_kv_caches(
    ...
    ----------
    kv_cache_cross_attn
        tuple[kv_cache_cross_attn_0_key, kv_cache_cross_attn_0_val, cv_cache_cross_attn_1_key, ...].
        Cross attn KV cache generated by CrossAttnKVGenerator.
        len(tuple) == 2 * number of source model decoder layers.
    kv_cache_attn
        tuple[kv_cache_attn_0_key, kv_cache_attn_0_val cv_cache_attn_1_key, ...].
...
def get_empty_attn_cache(
    ...
    embeddings_per_head
        The count of the embeddings in each decoder attention head.
